...
def run_migrations():
    MIGRATIONS = [
        ...
        ("idx", "posts_username",    "CREATE INDEX IF NOT EXISTS idx_posts_username ON posts(username)"),
        ("idx", "posts_created_at",  "CREATE INDEX IF NOT EXISTS idx_posts_created_at ON posts(created_at DESC)"),
        ("idx", "likes_post_id",     "CREATE INDEX IF NOT EXISTS idx_likes_post_id ON likes(post_id)"),
        ("idx", "comments_post_id",  "CREATE INDEX IF NOT EXISTS idx_comments_post_id ON comments(post_id)"),
        ("idx", "calendar_username", "CREATE INDEX IF NOT EXISTS idx_calendar_username ON calendar_events(username)"),
